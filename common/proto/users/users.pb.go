...
var file_common_proto_users_users_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0xca, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
...
var file_common_proto_users_users_proto_depIdxs = []int32{
	...
	4, // 5: proto.UserService.RegisterUser:output_type -> proto.RegisterMessage
	3, // 6: proto.UserService.LoginUser:output_type -> proto.LoginResponse
	6, // 7: proto.UserService.CreateRating:output_type -> proto.ReviewMessage
	0, // 8: proto.UserService.GetUserByID:output_type -> proto.User
	9, // 9: proto.UserService.ChargeUserWallet:output_type -> proto.ChargeResponse
